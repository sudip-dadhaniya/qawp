    ...
    private function define_admin_hooks() {
        ...
        if ( wpap_fs()->is__premium_only() ) {
            if ( wpap_fs()->can_use_premium_code() ) {
                ...
                $this->loader->add_action('admin_footer-' . $screen_id, $plugin_admin, 'wcpoa_print_script_in_footer');
                $this->loader->add_action('admin_head', $plugin_admin, 'wcpoa_remove_admin_menus__premium_only');
                $this->loader->add_action('add_meta_boxes_' . $screen_id, $plugin_admin, 'wcpoa_add_my_meta_box__premium_only');
                $this->loader->add_action('load-' . $screen_id, $plugin_admin, 'wcpoa_add_my_meta_box__premium_only');
                $this->loader->add_action('wp_ajax_product_ajax', $plugin_admin, 'get_product_ajax__premium_only');
                $this->loader->add_action('wp_ajax_category_ajax', $plugin_admin, 'get_category_ajax__premium_only');
                $this->loader->add_action('wp_ajax_tag_ajax', $plugin_admin, 'get_tag_ajax__premium_only');
            }
        }
