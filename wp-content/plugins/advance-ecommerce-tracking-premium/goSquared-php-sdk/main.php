<?php
require_once(ADVANCE_ECOMMERCE_TRACKING_PLUGIN_BASENAME. '/Person.php');
require_once(ADVANCE_ECOMMERCE_TRACKING_PLUGIN_BASENAME . '/Transaction.php');
require_once(ADVANCE_ECOMMERCE_TRACKING_PLUGIN_BASENAME . '/Now.php');
require_once(ADVANCE_ECOMMERCE_TRACKING_PLUGIN_BASENAME . '/Trends.php');
require_once(ADVANCE_ECOMMERCE_TRACKING_PLUGIN_BASENAME . '/Ecommerce.php');
require_once(ADVANCE_ECOMMERCE_TRACKING_PLUGIN_BASENAME . '/Account.php');
...
class GoSquared{
  ...
  function __construct($opts = false){
    ...
    $json_parse_composer = json_decode(file_get_contents(ADVANCE_ECOMMERCE_TRACKING_PLUGIN_BASENAME . '/composer.json'), true);
    $this->version = $json_parse_composer['version'];
    $this->opts = $opts;
