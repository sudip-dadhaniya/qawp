...
if ( $post_data->post_content ) {
	...
	printf( '<div class="chart-content"><span>%s</span>%s</div>',
		esc_html__( 'How to measure', 'size-chart-for-woocommerce' ),
...
if ( $chart_image ) {
    ...
    <div class="chart-image">
        <img src="<?php echo esc_url( $chart_image[0] ); ?> " alt="<?php esc_attr_e( $post->post_title, 'size-chart-for-woocommerce' ); ?>" title="<?php esc_attr_e( $chart_label, 'size-chart-for-woocommerce' ); ?>"/>
    </div>
	<?php
}
