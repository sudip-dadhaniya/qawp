...
<div class="_thumbnails_container_" v-if="response_json.output">
    <div class="virtual-titles-result">
        ...
        <a :href="'<?php echo $download_url;?>/zipper/'+response_json.test_id" target="_blank" class="virtual-settings-btn flex-center" style="display: inline; padding: 6px 10px 6px;">
