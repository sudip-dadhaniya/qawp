...
function wp_store_widgets_show_widget_field($instance = '', $widget_field = '', $athm_field_value = '') {
    ...
    switch ($wp_store_widgets_field_type) {
        ...
        ?>
        <p>
            <label for="<?php echo esc_attr($instance->get_field_id($wp_store_widgets_name)); ?>"><?php echo esc_html($wp_store_widgets_title); ?>:</label>
            ...
            <br />
            <small><?php echo esc_html($wp_store_widgets_description); ?></small>
            <?php } ?>
        </p>
        <?php
        break;
        ...
        // Textarea field
            ...
            <p>
                <label for="<?php echo esc_attr($instance->get_field_id($wp_store_widgets_name)); ?>"><?php echo esc_html($wp_store_widgets_title); ?>:</label>
                <textarea class="widefat" rows="5" id="<?php echo esc_attr($instance->get_field_id($wp_store_widgets_name)); ?>" name="<?php echo esc_attr($instance->get_field_name($wp_store_widgets_name)); ?>"><?php echo esc_textarea($athm_field_value); ?></textarea>
            </p>
            <?php
            break;
        ...
        // Radio fields
            ...
            <p>
                <?php
                echo esc_html($wp_store_widgets_title);
                echo '<br />';
                foreach ($wp_store_widgets_field_options as $athm_option_name => $athm_option_title) {
                    ?>
                    <input id="<?php echo esc_attr($instance->get_field_id($athm_option_name)); ?>" name="<?php echo esc_attr($instance->get_field_name($wp_store_widgets_name)); ?>" type="radio" value="<?php echo esc_attr($athm_option_name); ?>" <?php checked($athm_option_name, $athm_field_value); ?> />
        ...
        // Select field
                ...
                ?>
                <p>
                    <label for="<?php echo esc_attr($instance->get_field_id($wp_store_widgets_name)); ?>"><?php echo esc_html($wp_store_widgets_title); ?>:</label><br />
